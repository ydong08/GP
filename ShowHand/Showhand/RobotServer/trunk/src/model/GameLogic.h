...
public:
	//对比扑克
	bool CompareCard(BYTE bFirstList[], BYTE bfCardCount, BYTE bLastList[], BYTE blCardCount);
	//对比两对
	bool CompareLiangDui(BYTE bFirstList[], BYTE bfCardCount, BYTE bLastList[], BYTE blCardCount);
	//对比对子
	bool CompareDuiZhi(BYTE bFirstList[], BYTE bfCardCount, BYTE bLastList[], BYTE blCardCount);
};
