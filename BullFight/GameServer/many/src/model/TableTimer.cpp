...
void TableTimer::startPhpPushCardTimer(int timeout)
{
	m_phpTimer.SetTimeEventObj(this, PHP_PUSH_CARD_TIMER);
	m_phpTimer.StartTimer(timeout);
}

void TableTimer::stopPhpPushCardTimer()
{
	m_phpTimer.StopTimer();
}
...
int TableTimer::ProcessOnTimerOut(int Timerid, int uid)
{
	...
	case PHP_PUSH_CARD_TIMER:
		return PhpPushCardTimeOut();
	default:
		return 0;
	}
	return 0;
...
int TableTimer::BetTimeOut()
{
	...
	//startPhpPushCardTimer(5);			//����ʱ��ǰ5�뱣�������ڵȴ�php���ƣ�5������������
...
int TableTimer::PhpPushCardTimeOut()
{
	table->GameOver();
	return 0;
}
