...
public:
	...
	static int game_id;
	static short source;
	static short config_type;

protected:
	////////////////////////////////////////////////////////////////////////////////
	bool _copy(const void *pInBuf, int nLen, int offset)
	{
		if (nLen + offset > PACKET_BUFFER_SIZE)
			return false;
		...
		memcpy(m_strBuf + offset, pInBuf, nLen);
		m_nPacketSize = nLen + offset;
		return true;
	}
	////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	{
		return base::_copy(pInBuf, nLen, 0);
	}
