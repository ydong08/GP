...
//----------static-------------------
public:
	static bool  InitLogger( unsigned char levelLimit, std::string logFile, unsigned short serverId,
							 std::string ip = "", uint16_t port = 0, uint32_t maxFileSize = 100, bool redirect_stdout = false);
